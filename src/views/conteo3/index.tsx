...
import Conteo3Styles from "./conteo3.style";

const Conteo3: FC<{ navigation: any }> = ({ navigation }) => {
    // States
    ...
    return (
        <React.Fragment>
            ...
            />
            <View style={Conteo3Styles.view}>
                <Stack style={Conteo3Styles.tabsContent}>
