...
const Instructions4: FC<IGeneralProps> = (props) => {
    const redirect = (): void => {
        ...
        <React.Fragment>
            ...
            <View style={InstructionsStyles.view}>
                <View style={InstructionsStyles.subContent}>
                    <Button variant="unstyled" onPress={() => navigation.navigate('Instructions5')}>
                        <Image
                            source={require('../../assets/images/Instructions4.png')}
