...
import AlertCalificacion2Styles from './AlertCalificacion2.styles';

const AlertCalificacion2: FC<IGeneralProps> = (props) => {
    const redirect = (): void => {
    ...
    return (
        <React.Fragment>
            ...
            />
            <View style={AlertCalificacion2Styles.view}>
                <View style={AlertCalificacion2Styles.subContent}>
                    <Button variant="unstyled" onPress={() => navigation.navigate('Welcome')}>
                        <Image
                            source={require('../../assets/images/agradecer.png')}
...
export default AlertCalificacion2;